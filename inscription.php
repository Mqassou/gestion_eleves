	 ...
	 if(isset($_POST["inscription"]))
			 {
				...
				try { 
				$requete="INSERT INTO `eleve`(`nom_eleve`, `prenom_eleve`, `adresse`, `code_postal`, `ville`, `tel_domicile`, `tel_mobile`, `date_naissance`, `sexe`, `date_inscription`, `etablissement`, `vaccinations`, `allergies`, `remarques`,`num_groupe`) 
												VALUES ('$nom','$prenom','$adresse','$code_postal','$ville','$tel_domicile','$tel_mobile','$date_naissance','$sexe','$date_inscription','$etablissement ',' $vaccinations','$allergies','$remarques','$num_groupe')";
					$pdo->query($requete);
